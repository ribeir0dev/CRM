...
<div class="card shadow-sm">
  <div class="card-body">
    ...
    <div class="row fw-semibold text-muted small border-bottom pb-2 mb-2">
    ...
    <?php else: ?>
      <div class="row g-2">
        <?php foreach ($hospedagens as $h): ?>
          ...
          ?>
          <div class="col-12">
            <div class="card border-0 border-bottom rounded-0 px-2">
              <div class="card-body py-2">
                <div class="row align-items-center small">
                  ...
                  <div class="col-12 col-md-2 text-end mt-2 mt-md-0">
                    <form method="post"
                          action="/actions/cadastrar_hospedagem.php"
